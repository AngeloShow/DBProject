...
<html lang="en">
  ...
  <link rel="icon" href="img/icon.ico">
    ...
    <script type="text/javascript">
      ...
      function random_img() {
        var str=document.getElementById("photocontainer").style.backgroundImage;
        ...
        $.ajax({
          ...
          success: function(data){
            var temp= JSON.parse(data);
            document.getElementById("photocontainer").style.backgroundImage = "url("+data+")";
          }
        });
      }
    ...
    <style>
      ...
      #photocontainer{ background-color: transparent; background-image: url("copertine/0.jpg"); background-size: contain; background-repeat: no-repeat; color: white;  display: block; width: 15%; height: 20%; position: absolute;
